...
var TaskModel = {
  ...
  serializer: /* @__PURE__ */ __name((obj) => {
    ...
    return {
      ...obj,
      completed: Boolean(task2.completed)
    };
  }, "serializer"),
...
var TaskList = class extends D1ListEndpoint {
  ...
  schema = {
    ...
    description: "Retorna uma lista paginada de todas as tasks do usu\xE1rio autenticado"
  };
...
var TaskCreate = class extends D1CreateEndpoint {
  ...
  schema = {
    ...
    description: "Cria uma nova task para o usu\xE1rio autenticado"
  };
};
...
var TaskRead = class extends D1ReadEndpoint {
  ...
  schema = {
    security: [{ bearerAuth: [] }],
    tags: ["Tasks"],
    summary: "Obt\xE9m uma task espec\xEDfica",
    description: "Retorna os detalhes de uma task espec\xEDfica do usu\xE1rio autenticado"
  };
};
...
var TaskUpdate = class extends D1UpdateEndpoint {
  ...
  schema = {
    ...
    description: "Atualiza os dados de uma task espec\xEDfica do usu\xE1rio autenticado"
  };
};
...
var TaskDelete = class extends D1DeleteEndpoint {
  ...
  schema = {
    ...
    description: "Remove uma task espec\xEDfica do usu\xE1rio autenticado"
  };
};
...
// src/endpoints/auth/base.ts
var user = external_exports.object({
  id: external_exports.number().int(),
  nome: external_exports.string().min(2, "Nome deve ter pelo menos 2 caracteres").max(100, "Nome deve ter no m\xE1ximo 100 caracteres"),
  email: external_exports.string().email("Email deve ter formato v\xE1lido").max(255, "Email deve ter no m\xE1ximo 255 caracteres"),
  senha: external_exports.string().min(8, "Senha deve ter pelo menos 8 caracteres"),
  role: external_exports.enum(["admin", "user", "viewer"], {
    errorMap: /* @__PURE__ */ __name(() => ({ message: "Role deve ser admin, user ou viewer" }), "errorMap")
  }),
  active: external_exports.boolean(),
  created_at: external_exports.string().datetime(),
  updated_at: external_exports.string().datetime()
});
var userRegister = external_exports.object({
  nome: external_exports.string().min(2, "Nome deve ter pelo menos 2 caracteres").max(100, "Nome deve ter no m\xE1ximo 100 caracteres"),
  email: external_exports.string().email("Email deve ter formato v\xE1lido").max(255, "Email deve ter no m\xE1ximo 255 caracteres"),
  senha: external_exports.string().min(8, "Senha deve ter pelo menos 8 caracteres").regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)/, "Senha deve conter pelo menos 1 mai\xFAscula, 1 min\xFAscula e 1 n\xFAmero"),
  role: external_exports.enum(["admin", "user", "viewer"], {
    errorMap: /* @__PURE__ */ __name(() => ({ message: "Role deve ser admin, user ou viewer" }), "errorMap")
  }).default("user")
});
var userLogin = external_exports.object({
  email: external_exports.string().email("Email deve ter formato v\xE1lido"),
  senha: external_exports.string().min(1, "Senha \xE9 obrigat\xF3ria")
});
var userResponse = user.omit({ senha: true });
var jwtPayload = external_exports.object({
  sub: external_exports.string(),
  // user id (string conforme padrão JWT)
...
function textToArrayBuffer(str2) {
  return byteStringToBytes(str2);
}
...
function textToBase64Url(str2) {
  const encoder = new TextEncoder();
  const charCodes = encoder.encode(str2);
...
async function generateJWT(payload, secret, expiresIn = 86400) {
  ...
  return await sign(jwtPayload2, secret);
}
__name(generateJWT, "generateJWT");
async function verifyJWT(token, secret) {
  try {
    const isValid2 = await verify(token, secret);
    if (!isValid2) {
      return null;
    }
...
async function generateRefreshToken(userId, secret) {
  const payload = {
    sub: userId.toString(),
    // Converte para string
    type: "refresh"
...
var AuthRegister = class extends OpenAPIRoute {
  static {
    __name(this, "AuthRegister");
  }
  schema = {
    tags: ["Autentica\xE7\xE3o"],
    summary: "Registrar novo usu\xE1rio",
    description: "Cria uma nova conta de usu\xE1rio no sistema",
    request: {
    ...
    responses: {
      ...
      "409": {
        description: "Email j\xE1 existe",
        ...contentJson(
          external_exports.object({
            success: external_exports.boolean(),
            message: external_exports.string()
  ...
  async handle(c) {
    try {
      ...
      if (!newUser) {
        throw new Error("Erro ao recuperar usu\xE1rio criado");
      }
...
var AuthLogin = class extends OpenAPIRoute {
  static {
    __name(this, "AuthLogin");
  }
  schema = {
    tags: ["Autentica\xE7\xE3o"],
    summary: "Login de usu\xE1rio",
    description: "Autentica um usu\xE1rio e retorna tokens de acesso",
    request: {
    ...
    responses: {
      ...
      "403": {
        description: "Usu\xE1rio inativo",
        ...contentJson(
          external_exports.object({
            success: external_exports.boolean(),
            message: external_exports.string()
    ...
    try {
      ...
      if (!user2.active) {
        return c.json(
          {
            success: false,
            message: "Usu\xE1rio inativo. Entre em contato com o administrador."
          },
          403
        );
      }
...
var refreshTokenSchema = external_exports.object({
  refreshToken: external_exports.string().min(1, "Refresh token \xE9 obrigat\xF3rio")
});
var AuthRefresh = class extends OpenAPIRoute {
  static {
    __name(this, "AuthRefresh");
  }
  schema = {
    tags: ["Autentica\xE7\xE3o"],
    summary: "Renovar token de acesso",
    description: "Renova o token de acesso usando um refresh token v\xE1lido",
    request: {
    ...
    responses: {
      ...
      "401": {
        description: "Refresh token inv\xE1lido",
        ...contentJson(
          external_exports.object({
            success: external_exports.boolean(),
            message: external_exports.string()
    ...
    try {
      ...
      if (!userId) {
        return c.json(
          {
            success: false,
            message: "Refresh token inv\xE1lido ou expirado"
          },
          401
        );
      }
      ...
      if (!user2) {
        return c.json(
          {
            success: false,
            message: "Usu\xE1rio n\xE3o encontrado ou inativo"
          },
          401
        );
      }
...
// src/endpoints/auth/me.ts
var AuthMe = class extends OpenAPIRoute {
  static {
    __name(this, "AuthMe");
  }
  schema = {
    tags: ["Autentica\xE7\xE3o"],
    summary: "Obter dados do usu\xE1rio atual",
    ...
    responses: {
      "200": {
        description: "Dados do usu\xE1rio obtidos com sucesso",
        ...contentJson({
          success: external_exports.boolean(),
          message: external_exports.string(),
          data: external_exports.object({
      ...
      "401": {
        description: "Token inv\xE1lido ou n\xE3o fornecido",
        ...contentJson({
          success: external_exports.boolean(),
          message: external_exports.string()
        })
  ...
  async handle(c) {
    try {
      ...
      return c.json(
        {
          success: true,
          message: "Dados do usu\xE1rio obtidos com sucesso",
          data: {
            user: {
              id: user2.id,
              nome: user2.nome,
...
var authRouter = fromHono(new Hono2());
...
// src/endpoints/servicos/base.ts
var servico = external_exports.object({
  id: external_exports.number().int(),
  nome: external_exports.string().min(2, "Nome deve ter pelo menos 2 caracteres").max(100, "Nome deve ter no m\xE1ximo 100 caracteres"),
  descricao: external_exports.string().max(500, "Descri\xE7\xE3o deve ter no m\xE1ximo 500 caracteres").optional(),
  preco: external_exports.number().positive("Pre\xE7o deve ser um valor positivo").multipleOf(0.01, "Pre\xE7o deve ter no m\xE1ximo 2 casas decimais").optional(),
  ativo: external_exports.boolean(),
  created_at: external_exports.string().datetime(),
  updated_at: external_exports.string().datetime()
});
var servicoCreate = servico.omit({
  id: true,
  created_at: true,
  updated_at: true
});
var servicoUpdate = servicoCreate.partial();
var servicoResponse = servico.omit({});
var ServicoModel = {
  tableName: "servicos",
  primaryKeys: ["id"],
  schema: servico,
  serializer: /* @__PURE__ */ __name((obj) => {
    ...
    return {
      ...obj,
      ativo: Boolean(servico2.ativo),
      preco: servico2.preco ? Number(servico2.preco) : null
    };
  }, "serializer"),
  serializerObject: servico
};

// src/endpoints/servicos/servicoList.ts
var ServicoList = class extends D1ListEndpoint {
  static {
    __name(this, "ServicoList");
  }
  _meta = {
    model: ServicoModel
  };
  ...
  schema = {
    tags: ["Servi\xE7os"],
    summary: "Lista servi\xE7os dispon\xEDveis",
    description: "Retorna lista paginada de servi\xE7os ativos. Suporta busca por nome e descri\xE7\xE3o."
  };
};

// src/endpoints/servicos/servicoCreate.ts
var ServicoCreate = class extends D1CreateEndpoint {
  static {
    __name(this, "ServicoCreate");
  }
  _meta = {
    model: ServicoModel,
  ...
  schema = {
    security: [{ bearerAuth: [] }],
    tags: ["Servi\xE7os"],
    summary: "Cria novo servi\xE7o",
    description: "Cria um novo servi\xE7o no sistema. Requer autentica\xE7\xE3o com role admin."
  };
};

// src/endpoints/servicos/servicoRead.ts
var ServicoRead = class extends D1ReadEndpoint {
  static {
    __name(this, "ServicoRead");
  }
  _meta = {
    model: ServicoModel
  };
  schema = {
    tags: ["Servi\xE7os"],
    summary: "Busca servi\xE7o por ID",
    description: "Retorna os detalhes de um servi\xE7o espec\xEDfico pelo seu ID."
  };
};

// src/endpoints/servicos/servicoUpdate.ts
var ServicoUpdate = class extends D1UpdateEndpoint {
  static {
    __name(this, "ServicoUpdate");
  }
  _meta = {
    model: ServicoModel,
    fields: ServicoModel.schema.pick({
  ...
  schema = {
    security: [{ bearerAuth: [] }],
    tags: ["Servi\xE7os"],
    summary: "Atualiza servi\xE7o existente",
    description: "Atualiza os dados de um servi\xE7o existente. Requer autentica\xE7\xE3o com role admin."
  };
};

// src/endpoints/servicos/servicoDelete.ts
var ServicoDelete = class extends D1DeleteEndpoint {
  static {
    __name(this, "ServicoDelete");
  }
  _meta = {
    model: ServicoModel
  };
  schema = {
    security: [{ bearerAuth: [] }],
    tags: ["Servi\xE7os"],
    summary: "Exclui servi\xE7o existente",
    description: "Remove um servi\xE7o do sistema. Requer autentica\xE7\xE3o com role admin."
  };
};

// src/endpoints/servicos/router.ts
var servicosRouter = fromHono(new Hono2());
...
// src/endpoints/contatos/base.ts
var telefoneRegex = /^(?:\+55)?\s?\(?([1-9]{2})\)?\s?9?\s?([0-9]{4,5})-?([0-9]{4})$/;
var contato = external_exports.object({
  id: external_exports.number().int(),
  nome: external_exports.string().min(2, "Nome deve ter pelo menos 2 caracteres").max(100, "Nome deve ter no m\xE1ximo 100 caracteres"),
  email: external_exports.string().email("Email deve ter formato v\xE1lido").max(255, "Email deve ter no m\xE1ximo 255 caracteres"),
  telefone: external_exports.string().regex(telefoneRegex, "Telefone deve estar no formato brasileiro: (11) 99999-9999"),
  empresa: external_exports.string().max(100, "Nome da empresa deve ter no m\xE1ximo 100 caracteres").optional(),
  servico_id: external_exports.number().int().positive("ID do servi\xE7o deve ser um n\xFAmero positivo"),
  mensagem: external_exports.string().min(10, "Mensagem deve ter pelo menos 10 caracteres").max(1e3, "Mensagem deve ter no m\xE1ximo 1000 caracteres"),
  status: external_exports.enum(["novo", "em_andamento", "respondido", "finalizado"], {
    errorMap: /* @__PURE__ */ __name(() => ({ message: "Status deve ser: novo, em_andamento, respondido ou finalizado" }), "errorMap")
  }),
  created_at: external_exports.string().datetime(),
  updated_at: external_exports.string().datetime()
});
var contatoCreate = contato.omit({
  id: true,
  status: true,
  created_at: true,
  updated_at: true
});
var contatoUpdateStatus = external_exports.object({
  status: external_exports.enum(["novo", "em_andamento", "respondido", "finalizado"], {
    errorMap: /* @__PURE__ */ __name(() => ({ message: "Status deve ser: novo, em_andamento, respondido ou finalizado" }), "errorMap")
  })
});
var contatoResponse = contato.extend({
  servico: external_exports.object({
    id: external_exports.number().int(),
...
__name(formatarTelefone, "formatarTelefone");

// src/endpoints/contatos/contatoCreate.ts
var ContatoCreate = class extends D1CreateEndpoint {
  static {
    __name(this, "ContatoCreate");
  }
  _meta = {
    model: ContatoModel,
  ...
  schema = {
    ...
    description: "Endpoint p\xFAblico para cria\xE7\xE3o de contatos atrav\xE9s do formul\xE1rio do site"
  };
  async beforeCreate(c, data) {
    const servico2 = await c[0].env.DB.prepare(
      "SELECT id, nome FROM servicos WHERE id = ? AND ativo = 1"
    ).bind(data.servico_id).first();
    if (!servico2) {
      throw new Error("Servi\xE7o n\xE3o encontrado ou n\xE3o est\xE1 dispon\xEDvel");
    }
...
// src/endpoints/contatos/contatoList.ts
var ContatoList = class extends D1ListEndpoint {
  static {
    __name(this, "ContatoList");
  }
  _meta = {
    model: ContatoModel
  };
  schema = {
    ...
    description: "Retorna lista paginada de contatos. Requer autentica\xE7\xE3o com role admin ou user."
  };
  searchFields = ["nome", "email"];
  defaultOrderBy = "created_at DESC";
};

// src/endpoints/contatos/contatoRead.ts
var ContatoRead = class extends D1ReadEndpoint {
  static {
    __name(this, "ContatoRead");
  }
  _meta = {
    model: ContatoModel
  };
  schema = {
    ...
    description: "Retorna os detalhes de um contato espec\xEDfico pelo seu ID. Requer autentica\xE7\xE3o."
  };
};

// src/endpoints/contatos/contatoUpdateStatus.ts
var ContatoUpdateStatus = class extends D1UpdateEndpoint {
  static {
    __name(this, "ContatoUpdateStatus");
  }
  _meta = {
    model: ContatoModel,
    fields: ContatoModel.schema.pick({
  ...
  schema = {
    ...
    description: "Atualiza o status de um contato espec\xEDfico. Requer autentica\xE7\xE3o com role admin ou user."
  };
};

// src/middleware/rateLimiting.ts
var requestCounts = /* @__PURE__ */ new Map();
function rateLimiter(maxRequests = 5, windowMs = 6e4) {
  return async (c, next) => {
...
__name(cleanupRateLimitCache, "cleanupRateLimitCache");

// src/endpoints/contatos/router.ts
var app = new Hono2();
app.use("/", rateLimiter(5, 6e4));
var contatosRouter = fromHono(app);
contatosRouter.post("/", ContatoCreate);
contatosRouter.get("/", ContatoList);
contatosRouter.get("/:id", ContatoRead);
contatosRouter.put("/:id/status", ContatoUpdateStatus);

// src/endpoints/testimonials/base.ts
var testimonial = external_exports.object({
  id: external_exports.number().int(),
  name: external_exports.string().min(2, "Nome deve ter pelo menos 2 caracteres").max(100, "Nome deve ter no m\xE1ximo 100 caracteres"),
  company: external_exports.string().max(100, "Nome da empresa deve ter no m\xE1ximo 100 caracteres").optional(),
  message: external_exports.string().min(10, "Mensagem deve ter pelo menos 10 caracteres").max(1e3, "Mensagem deve ter no m\xE1ximo 1000 caracteres"),
  rating: external_exports.number().int().min(1, "Avalia\xE7\xE3o deve ser entre 1 e 5").max(5, "Avalia\xE7\xE3o deve ser entre 1 e 5"),
  photo: external_exports.string().url("URL da foto deve ser v\xE1lida").optional(),
  created_at: external_exports.string().datetime(),
  updated_at: external_exports.string().datetime()
});
var testimonialCreate = testimonial.omit({
  id: true,
  created_at: true,
  updated_at: true
});
var testimonialUpdate = testimonialCreate.partial();
var TestimonialModel = {
  tableName: "testimonials",
  primaryKeys: ["id"],
  schema: testimonial,
  serializer: /* @__PURE__ */ __name((obj) => {
    const testimonial2 = obj;
    return {
      ...obj,
      rating: Number(testimonial2.rating),
      company: testimonial2.company || null,
      photo: testimonial2.photo || null
    };
  }, "serializer"),
  serializerObject: testimonial
};

// src/endpoints/testimonials/testimonialCreate.ts
var TestimonialCreate = class extends D1CreateEndpoint {
  static {
    __name(this, "TestimonialCreate");
  }
  _meta = {
  ...
  schema = {
    ...
    description: "Cria um novo testimonial no sistema. Endpoint p\xFAblico."
  };
...
// src/endpoints/testimonials/testimonialList.ts
var TestimonialList = class extends D1ListEndpoint {
  static {
    __name(this, "TestimonialList");
  }
  _meta = {
    model: TestimonialModel
  };
  schema = {
    ...
    description: "Lista todos os testimonials com pagina\xE7\xE3o. Endpoint p\xFAblico."
  };
};

// src/endpoints/testimonials/testimonialRead.ts
var TestimonialRead = class extends D1ReadEndpoint {
  static {
    __name(this, "TestimonialRead");
  }
  _meta = {
    model: TestimonialModel
  };
  schema = {
    ...
    description: "Retorna um testimonial espec\xEDfico pelo ID. Endpoint p\xFAblico."
  };
};

// src/endpoints/testimonials/testimonialUpdate.ts
var TestimonialUpdate = class extends D1UpdateEndpoint {
  static {
    __name(this, "TestimonialUpdate");
  }
  _meta = {
    model: TestimonialModel,
    fields: TestimonialModel.schema.pick({
  ...
  schema = {
    ...
    description: "Atualiza um testimonial existente. Requer autentica\xE7\xE3o com role admin."
  };
...
// src/endpoints/testimonials/testimonialDelete.ts
var TestimonialDelete = class extends D1DeleteEndpoint {
  static {
    __name(this, "TestimonialDelete");
  }
  _meta = {
    model: TestimonialModel
  };
  schema = {
    ...
    description: "Exclui um testimonial existente. Requer autentica\xE7\xE3o com role admin."
  };
};

// src/endpoints/testimonials/router.ts
var app2 = new Hono2();
app2.use("/", rateLimiter(5, 6e4));
var testimonialsRouter = fromHono(app2);
testimonialsRouter.post("/", TestimonialCreate);
testimonialsRouter.get("/", TestimonialList);
testimonialsRouter.get("/:id", TestimonialRead);
testimonialsRouter.put("/:id", TestimonialUpdate);
testimonialsRouter.delete("/:id", TestimonialDelete);
...
var openapi = fromHono(app3, {
  docs_url: "/",
  schema: {
    info: {
      title: "API Sistema de Contabilidade",
      version: "2.0.0",
      description: "API completa para sistema de contabilidade com autentica\xE7\xE3o JWT."
    }
  }
});
openapi.registry.registerComponent("securitySchemes", "bearerAuth", {
  ...
  scheme: "bearer",
  bearerFormat: "JWT",
  description: "Token JWT obtido atrav\xE9s do endpoint de login"
});
...
// .wrangler/tmp/bundle-UxChVp/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-UxChVp/middleware-loader.entry.ts
